...
void LOAD_BIG_RAYMAN(void)
{
    ...
    D_801F4410 = (void *) file_ram+0xD0000;
    D_801F5160 = (void *) file_ram+0xD0000;
    D_801F7E90 = *(s32 *) file_ram+0xD0004 + (void *) file_ram+0xD0000;
    FUN_80132424();
...
void LOAD_ALL_FIX(void)
{
    ...
    D_801F4410 = (void *) file_ram+0x10000;
    D_801F5160 = (void *) file_ram+0x10000;
    PS1_AllFixData = *(s32 *) file_ram+0x10004 + (void *) file_ram+0x10000;
    D_801F4380 = *(s32 *) file_ram+0x10008 + (void *) file_ram+0x10000;
    PS1_LoadAllFixTextures(*(s32 *) file_ram+0x1000C - *(s32 *) file_ram+0x10008);
...
void load_world(s16 world)
{
    ...
    D_801F4410 = (void *) file_ram+0x5866C;
    D_801F5160 = (void *) file_ram+0x5866C;
    D_801D7840 = *(s32 *) file_ram+0x58674 + (void *) file_ram+0x5866C;
    D_801F4380 = *(s32 *) file_ram+0x58678 + (void *) file_ram+0x5866C;
    D_801F8190 = *(s32 *) file_ram+0x58684 + (void *) file_ram+0x5866C;
    FUN_8013948c(*(s32 *) file_ram+0x5867C - *(s32 *) file_ram+0x58678);
    ...
    D_801CEE9A = 0;
    no_fnd = -1;
    D_801E5260 = (s32*)(file_ram+((uintptr_t)D_801C438C[world - 1] - (uintptr_t)0x80000000));
    D_801F59E0 = (s32*)(file_ram+((uintptr_t)D_801C4374[world - 1] - (uintptr_t)0x80000000));
...
void LOAD_SCREEN(void)
{
    ...
    PS1_LdrFiles[0].dest = (void *) file_ram+0x5866C;
    PS1_Disable_all_Callbacks();
...
{
    D_801F4380 = (void *) file_ram+0x5866C;
    PS1_LdrFiles[1].dest = (void *) file_ram+0x5866C;
    PS1_Disable_all_Callbacks();
...
s16 FUN_8019ebc0(void)
{
    if (PS1_ShouldClearPassword)
    {
        ...
        case 1:
            D_801F4380 = (void *) file_ram+0x5866C;
            PS1_PreFiles[0].dest = (void *) file_ram+0x5866C;
    ...
    {
        D_801F4380 = (void *) file_ram+0x5866C;
        PS1_PreFiles[4].dest = (void *) file_ram+0x5866C;
        PS1_FileTemp = PS1_LoadFiles(PS1_PreFiles, 4, 1, 0);
        plan2_width = 146;
        plan2_height = 150;
        D_801E4B58 = false;
...
void LOAD_CREDITS_VIGNET(void)
{
    ...
    case 0:
        D_801F4380 = (void *) file_ram+0x5866C;
        PS1_CrdFiles[0].dest = (void *) file_ram+0x5866C;
